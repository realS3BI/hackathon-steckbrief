...
export function Brand({ compact = false }: { compact?: boolean }) {
  return <Link className="brand" href="/" aria-label="Summit Sounds, home"><span className="brand-symbol"><AudioLines aria-hidden="true" /></span><span>summit<span className="brand-rest"> sounds</span><span className="brand-dot">.</span>{!compact && <small>Our team album</small>}</span></Link>;
}
